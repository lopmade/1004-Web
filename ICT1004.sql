...
insert into item_image (item_id,image) values ('1','001_Bulbasaur.png');
...
insert into item_image (item_id,image) values ('2','004_Charmander.png');
...
insert into item_image (item_id,image) values ('3','007_Squirtle.png');
